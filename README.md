...
To initialize your local repository using the OMNIROM trees to build TWRP, use a command like this:
    ...
    repo init -u https://github.com/5E7EN/platform_manifest_twrp_omni.git -b twrp-9.0

(Recommended) To initialize a shallow clone, which will save even more space, use a command like this:
